...
key = "P+iXBZpbV9pvZJPgCKLcTM+iaJ21gCDlJ4CJ/sv0MLe4LKOrGTIJ3hGZqEK3mwEa0o1DzUQx1eCf6NsgB0lKSw=="
storename = "novelisadlsg2"
container = "digital-coe-de"

spark.conf.set("fs.azure.account.key." + storename + ".dfs.core.windows.net", key)
spark.conf.set("fs.azure.createRemoteFileSystemDuringInitialization", "true")
dbutils.fs.ls("abfss://" + container + "@" + storename + ".dfs.core.windows.net/")
spark.conf.set("fs.azure.createRemoteFileSystemDuringInitialization", "false")


#spark.conf.set("fs.azure.createRemoteFileSystemDuringInitialization", "true")
#dbutils.fs.ls("abfss://deltatesting@devnovelisgen2namespace.dfs.core.windows.net/")
...
df.write.format('delta').mode('overwrite').partitionBy('plant_name','machine_center','file_name').option('path',DESTINATION_PATH).saveAsTable(DB_NAME+'.'+TABLE_NAME)