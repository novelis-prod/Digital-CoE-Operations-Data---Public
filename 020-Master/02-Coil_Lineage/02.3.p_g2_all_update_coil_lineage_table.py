...
df123 = spark.sql("SELECT {},{},{},{},{},{},{},{},{},{},{},{},{},{} FROM {}.{} WHERE {} NOT LIKE '0.0' ORDER BY {},{}".format(metal_code, machine_center_desc, ops_seq, machine_center_seq,use_index, eRg_EntryHeadDiscard, eRg_EntryTailDiscard, eRg_ExitHeadDiscard, eRg_ExitTailDiscard, eRg_EntryRolledLength, eRg_ExitRolledLength, ex_head_pos, ex_tail_pos, eRg_Ratio, ent_db, coil_lineage_tbl, table_name, metal_code, ops_seq))
...
# MAGIC %sql select count(distinct metal_code) from opsentprodg2.coil_lineage where ex_tail_pos>0 and machine_center_desc = 'HRM'
...
cl.alias("cli").merge(df123_mc_new.alias("df123_mn"), "cli.metal_code = df123_mn.metal_code AND cli.ops_seq = df123_mn.ops_seq and cli.machine_center_seq = df123_mn.machine_center_seq")\
