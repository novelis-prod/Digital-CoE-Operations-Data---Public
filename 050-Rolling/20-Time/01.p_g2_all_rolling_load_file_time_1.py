...
# MAGIC 
# MAGIC Output: Run other notebook to get unprocessed files data from file log time table
...
notebook_to_run ='/de_digital_coe/prodg2/050-Rolling/20-Time/02.p_g2_all_rolling_load_file_time_2'
...
pool.map(lambda machine_center : dbutils.notebook.run(notebook_to_run,0,{'machine_center':machine_center,'plant_name':plant}),machine_list)  